...
begin
	...
	elseif any(real.(λ_jacob) .> 0)
	    println("The stationary point is UNSTABLE.")
	else
	    println("The stationary point is NON-HYPERBOLIC. Further analysis needed.")
	end
end
...
# Plot the results
plot(sol_2, vars=(0, 1), xlabel="Time (ms)", ylabel="Membrane Potential (mV)", label="V(t)")#, ylims=[-0., 30.])
