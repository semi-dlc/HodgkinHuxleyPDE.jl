...
# ╔═╡ ee0c28fe-ac7f-4f2f-b3a8-b09e3ace4e39
begin
	u0_AD = [ -62.0, 0.3177, 0.0529, 0.596 ] 
	p_AD = p
end

# ╔═╡ 4a568e49-63f8-44f1-9039-a27615cab088
begin
	# symbolic ∇ test
	J_S = D_hh(u0_AD, p_AD)
	@show J_S
...
# ╔═╡ da6edb84-b524-451e-aedc-17d84fa4d3d5
begin
	# AD ∇ test
	
	
	# Compute the Jacobian matrix at u0
	J_AD = D_hh_AD(u0_AD, p_AD)
	@show J_AD
end
...
br_po1 = continuation(
		...
		opts_br,
		δp= 0.002,
        PeriodicOrbitOCollProblem(30, 5),
		bothside=true
        )
...
plot(br, br_po1, branchlabel = ["equib" "periodic orbits"])#, xlims=[0.35, 0.41], ylims=[-65., -50.])
...
# next steps: Temperature effect on ODE (Bifurcation)
