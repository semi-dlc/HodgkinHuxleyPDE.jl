...
# ╔═╡ 91b8e5da-f96b-40bb-a384-609e836447da
md"Initial conditons"

# ╔═╡ d1200c57-fbd7-49c1-b0ec-ec94de850f19
...
# ╔═╡ 99638f22-df3a-42e4-b569-9ae22bd8dc95
...
CSV.write("outputs/hodgkin_huxley_solver_analysis.csv",results)
...
# ╔═╡ ab8e3d13-7dc6-4720-aad5-96bf6634ae60
md"Reference solution"

# ╔═╡ fece55c8-6c3c-4644-83a3-d572fbcec5e0
sol = solve(
			probODE, 
			TRBDF2(); 
			abstol = 1e-12, 
...
# ╔═╡ f7d1d7fa-cb78-4956-b325-bfaf2cdf06f7
...
# ╔═╡ 2e5c2ec2-c46a-46f1-a439-62fa275eec9d
md"Solver stepsizes"

# ╔═╡ 7c3eb0c8-3b1f-482c-bc8d-3d9f793001d6
plot!(stepsize_plot; size = (1000, 2000))
...
manifest_format = "2.0"
project_hash = "0fb32010ca9a8160486b25022c8c64fadfa320bd"
