...
# ╔═╡ a486f115-f76b-458f-8304-169788a2a0b8


# ╔═╡ 2599d035-4f40-43e5-b680-5d407b10df37
...
# Equiblirium continuation from I=10 to I=-3 
...
# ╔═╡ ed45d5bc-a2f7-446c-9d65-c5021fe18db2
plot(br, br_po1, branchlabel = ["equib" "periodic orbits"], xlims=[4.5, 8.], ylims=[-65., -30.])
# How is u1 / V calculated? average/min/max? 

# ╔═╡ 8a6ebe57-836c-4618-bada-9b66575ffbc4
plot(br, br_po2, branchlabel = ["equib" "periodic orbits"], xlims=[6., 8.], ylims=[-70., 20.])
# How is u1 / V calculated? average/min/max? 
...
sol1 = get_periodic_orbit(br_po2, 4) # get periodic orbit of br_po1 (detecting from second hopf bifurcation at the 4-th point)

# ╔═╡ 33a7668d-de26-4040-ab4f-10d4fba40209
begin
...
# next steps: Temperature effect on ODE (Bifurcation): Spike only within narrow temperature range.
# try I_stim experimentally around Hopf point: Not at I=0.4, but I = 0.373 -> Until 0.4: Only one spike.
# try new branch on blue point of green curve
# periodic doubling at I_0.4? Found nothing. -> Other direction
# 

# ╔═╡ c6f3ca54-4585-4d5c-b33f-0031485a5d09
#=
25.03.2025:
# try to get bifurcation branches from blue points
# possible to plot the two different (unstable/stable) branches differently?
# How do I get the stationary solutions to the curve in BifrucationKit
# Try Different Init. Conditions for spikes at boundary of spiking region (non-stationary) -> other results
# Export numerical data of bifurcation curves
# Why is there no stable point in spiking region?? There should be one!
=#

# ╔═╡ 7ae9c857-d9cf-4b46-b34a-d78fbb51f644
md"Paper:
